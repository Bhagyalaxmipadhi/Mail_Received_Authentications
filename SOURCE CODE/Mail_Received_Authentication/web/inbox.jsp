...
table.pos_left {
  ...
  <body>
	...
	Statement stmt=con1.createStatement();
			...
			<td><a href="viewmailcontent1.jsp?email=<%=rs1.getString(4)%>&time=<%=rs1.getString(5)%>&subject=<%=rs1.getString(2)%>&body=<%=rs1.getString(3)%>"><font color="blue">ViewMail</font></a></td>
